...
exports.updateConfig = async (req, res) => {
  try {
    ...
    const { 
      ...
      jumatMode, jumatDisplayStart, jumatDisplayEnd, jumatRunningTextEnabled, ramadanMode, alarmSound,
      adzanDuration,
      adzanBackground,
      adzanBackgroundUrl,
      adzanAudio,
    ...
    const updated = await prisma.prayerTimeConfig.update({
      ...
      data: {
        ...
        jumatDisplayStart: jumatDisplayStart !== undefined ? parseInt(jumatDisplayStart) : config.jumatDisplayStart,
        jumatDisplayEnd: jumatDisplayEnd !== undefined ? parseInt(jumatDisplayEnd) : config.jumatDisplayEnd,
